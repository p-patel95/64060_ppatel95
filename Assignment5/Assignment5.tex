...
\FunctionTok{data.frame}\NormalTok{(clusters)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Assignment5_files/figure-latex/unnamed-chunk-27-1.pdf}
...
\includegraphics{Assignment5_files/figure-latex/unnamed-chunk-28-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cereals\_clusts\_hc\_6}\SpecialCharTok{$}\NormalTok{cluster\_hc }\OtherTok{\textless{}{-}} \FunctionTok{as.factor}\NormalTok{(cereals\_clusts\_hc\_6}\SpecialCharTok{$}\NormalTok{cluster\_hc)}

\FunctionTok{ggparcoord}\NormalTok{(cereals\_clusts\_hc\_6,}
    \AttributeTok{columns =} \FunctionTok{c}\NormalTok{(}\DecValTok{4}\NormalTok{,}\DecValTok{5}\NormalTok{,}\DecValTok{8}\NormalTok{,}\DecValTok{9}\NormalTok{), }\AttributeTok{groupColumn =} \DecValTok{1}\NormalTok{,}
    \AttributeTok{showPoints =} \ConstantTok{TRUE}\NormalTok{, }
    \AttributeTok{title =} \StringTok{"Parallel Coordinate Plot for the Cereals"}\NormalTok{,}
    \AttributeTok{alphaLines =} \DecValTok{1}
...
\includegraphics{Assignment5_files/figure-latex/unnamed-chunk-29-1.pdf}
