...
* According to the Silhoutte, the optimized cluster value is 4. Lets check the stability of 4 clusters with clusterboot method now.
...
* Cluster 3 has the best options of healthy cereals that students can be served all 5 workdays - so that everyday with all different cereals. 
